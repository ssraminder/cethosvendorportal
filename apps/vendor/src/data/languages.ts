...
export const LANGUAGES: LanguageEntry[] = [
  ...
  // Reconciliation additions 2026-07-03 — parity with DB `languages` table (apply form) + admin list
  { code: "AS", name: "Assamese", group: "Assamese" },
  { code: "CHR", name: "Cherokee", group: "Cherokee" },
  { code: "NY", name: "Chichewa", group: "Chichewa" },
  { code: "CR", name: "Cree", group: "Cree" },
  { code: "DZ", name: "Dzongkha", group: "Dzongkha" },
  { code: "FO", name: "Faroese", group: "Faroese" },
  { code: "FJ", name: "Fijian", group: "Fijian" },
  { code: "FY", name: "Frisian", group: "Frisian" },
  { code: "HT", name: "Haitian Creole", group: "Haitian Creole" },
  { code: "HAW", name: "Hawaiian", group: "Hawaiian" },
  { code: "HIL", name: "Hiligaynon", group: "Hiligaynon" },
  { code: "ILO", name: "Ilocano", group: "Ilocano" },
  { code: "IU", name: "Inuktitut", group: "Inuktitut" },
  { code: "RW", name: "Kinyarwanda", group: "Kinyarwanda" },
  { code: "LA", name: "Latin", group: "Latin" },
  { code: "LG", name: "Luganda", group: "Luganda" },
  { code: "LB", name: "Luxembourgish", group: "Luxembourgish" },
  { code: "MI", name: "Maori", group: "Maori" },
  { code: "MH", name: "Marshallese", group: "Marshallese" },
  { code: "NV", name: "Navajo", group: "Navajo" },
  { code: "OR", name: "Odia", group: "Odia" },
  { code: "OJ", name: "Ojibwe", group: "Ojibwe" },
  { code: "ROM", name: "Romani", group: "Romani" },
  { code: "SM", name: "Samoan", group: "Samoan" },
  { code: "SA", name: "Sanskrit", group: "Sanskrit" },
  { code: "GD", name: "Scottish Gaelic", group: "Scottish Gaelic" },
  { code: "ST", name: "Sesotho", group: "Sesotho" },
  { code: "SN", name: "Shona", group: "Shona" },
  { code: "GSW", name: "Swiss German", group: "Swiss German" },
  { code: "TY", name: "Tahitian", group: "Tahitian" },
  { code: "TG", name: "Tajik", group: "Tajik" },
  { code: "BO", name: "Tibetan", group: "Tibetan" },
  { code: "TI", name: "Tigrinya", group: "Tigrinya" },
  { code: "TO", name: "Tongan", group: "Tongan" },
  { code: "TK", name: "Turkmen", group: "Turkmen" },
  { code: "UG", name: "Uyghur", group: "Uyghur" },
  { code: "YI", name: "Yiddish", group: "Yiddish" },
];
